...
ActiveRecord::Schema[7.0].define(version: 2023_08_22_072740) do
  ...
  create_table "countries", charset: "utf8mb4", collation: "utf8mb4_0900_bin", force: :cascade do |t|
    t.bigint "region_id"
    t.string "name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "ingredients", charset: "utf8mb4", collation: "utf8mb4_0900_bin", force: :cascade do |t|
  ...
  create_table "ratings", charset: "utf8mb4", collation: "utf8mb4_0900_bin", force: :cascade do |t|
    t.bigint "recipe_id", null: false
    t.bigint "user_id", null: false
  ...
  create_table "recipes", charset: "utf8mb4", collation: "utf8mb4_0900_bin", force: :cascade do |t|
  ...
  create_table "regions", charset: "utf8mb4", collation: "utf8mb4_0900_bin", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end

  create_table "types", charset: "utf8mb4", collation: "utf8mb4_0900_bin", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
